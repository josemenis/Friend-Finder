...
2. Your `app.js` file should require the basic npm packages we've used in class: `express` and `path`.
...
See the [Supplemental Heroku Deployment Guide](../../student-resources/HerokuGuide.md) for in-detail deployment instructions.
